...
$query = "SELECT * FROM uploadfile" or die("Error:"); 
...
while($row = mysqli_fetch_array($result)) { 
  ...
  echo "<td>"."<img src='PicUpload/".$row['fileupload']."' width='300'>"."</td>";
  echo "</tr>";
}
echo "</table>";
//5. close connection
...
?>
<br/>
<form action="UploadPic.php" method="post" enctype="multipart/form-data" name="upfile" id="upfile">
  <p>&nbsp;</p>
